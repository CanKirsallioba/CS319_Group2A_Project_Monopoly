...
public class CardTileActionStrategy extends ActionStrategy {
    /**
     * This method allows the player to draw and apply what the chance card commands.
     * @param player is the player that the action is inflicted on.
     */
    @Override
    public void button1Strategy(Player player) {
//        CardTile tile = (CardTile) player.getCurrentTile(); //

    }

    /**
     * This method allows the player to draw and apply what the community chest card commands.
     * @param player is the player that the action is inflicted on.
     */
    @Override
